                ...
                @auth
                    ...
                    <div class="hidden space-x-2 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        @if(auth()->user()->isBuyer())
                            ...
                            <x-nav-link :href="route('buyer.properties')" :active="request()->routeIs('buyer.properties*')">
                                Browse
                            </x-nav-link>
                        ...
                        @if($user->isSeller())
                            ...
                            <x-nav-link :href="route('seller.properties.create')"
                                :active="request()->routeIs('seller.properties.create')">
                                Add Property
                            </x-nav-link>

                            <x-nav-link :href="route('seller.properties.index')"
