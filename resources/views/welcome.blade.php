   ...
   <section class="max-w-7xl mx-auto px-6 py-24 md:py-32 grid md:grid-cols-2 gap-12 items-center">
        <div class="space-y-6 md:space-y-8">
            ...
            <p class="text-gray-600 text-lg md:text-xl">
                Smart real estate suggestions for buyers, sellers, and agents. Browse listings, manage your properties, or get  recommendations.
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <a href="/properties/latest" class="px-8 py-3 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-semibold shadow-lg hover:scale-105 transform transition">
                    Browse Properties
                </a>
                <a href="/buy/residential" class="px-8 py-3 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 font-semibold transition">
                    Start Buying
                </a>
            </div>
        </div>
        <div class="relative">
            ...
            <div class="absolute top-6 right-6 bg-white rounded-full px-4 py-2 shadow-md text-sm font-medium text-gray-700">
                Featured Listing
            </div>
        </div>
    </section>
